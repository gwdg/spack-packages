...
class Eccodes(CMakePackage):
    ...
    def cmake_args(self):
        ...
        if self.spec.satisfies("%oneapi"):
            args.append(self.define("CMAKE_EXE_LINKER_FLAGS", "-liomp5"))
            args.append(self.define("CMAKE_SHARED_LINKER_FLAGS", "-liomp5"))
            args.append(self.define("CMAKE_MODULE_LINKER_FLAGS", "-liomp5"))
            args.append(self.define("CMAKE_C_FLAGS", "-qopenmp"))
