...
class Hdf5(CMakePackage):
    ...
    variant("precise-fp", default=False, description="Enables precise floating point arithmetics")
    ...
    def flag_handler(self, name, flags):
        ...
        if name == "cflags":
            ...
            if spec.satisfies("+precise-fp"):
                cmake_flags.append("-fp-model=precise")
        elif name == "cxxflags":
